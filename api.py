...
async def check_coin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        user = update.message.from_user
        username = user.username or user.first_name or str(user.id)
...
def main():
    try:
        ...
        app.add_handler(CommandHandler("coin", check_coin_command))
